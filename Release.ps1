...
Write-Host $Root
$Solution = Get-ChildItem $Root "PK.NuGet.sln" -File
...
$PKNuGet = Get-ChildItem $Sources "PK.NuGet" -Directory
Write-Host $PKNuGet.FullName
$PKNuGetProj = Get-ChildItem $PKNuGet.FullName "PK.NuGet.csproj" -File
Write-Host $PKNuGetProj.FullName
